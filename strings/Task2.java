...
public class Task2 {
    public static void main(String[] args) {
        ...
        System.out.println(insertLetter(text,'b','a'));
    }

    public static String insertLetter(String text, char letter, char letterOfText ){
        StringBuilder strBuilder = new StringBuilder(text);
        for (int i = text.length()-1; i >= 0; i--) {
            if(text.charAt(i) == letterOfText){
                strBuilder.insert(i+1,letter);
            }
        }
