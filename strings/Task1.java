...
public class Task1 {
    public static void main(String[] args) {
        ...
        System.out.println("Наибольшее количество подряд идущих пробелов в тексте "
                +findTheMostNumberOfGaps(text));
    }

    public static int findTheMostNumberOfGaps(String text){
        int count = 0;
        int maxCount = count;
